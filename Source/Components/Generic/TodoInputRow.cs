...
{
    public sealed class TodoInputRow : Panel
    {
        ...
        {
            return (T) new TodoInputRow(input, description, tooltip) { Parent = parent }.Control;
        }
        
        public TodoInputRow(Control control, string description, string tooltip = null)
        {
